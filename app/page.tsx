    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div style={{ marginTop: "24px", flex: 1 }}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              placeholder="Enter your website (without https://)"
              style={{
                width: "100%",
                height: "40px",
                backgroundColor: "var(--gray-input)",
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          ...
          <DialogContent className="max-w-4xl min-h-[80vh] flex flex-col border-border">
            <DialogHeader>
      ...
      <div className="flex-grow bg-gray-200 dark:bg-gray-800 flex items-center justify-center p-8 relative">
        ...
        <div className="absolute bottom-6 right-6 flex gap-2">
          <button
            onClick={cycleTheme}
            className="p-2 bg-white dark:bg-gray-700 rounded-full shadow-lg hover:shadow-xl transition-shadow"
        ...
        {/* Email Mockup */}
        <div
          className="w-full max-w-4xl bg-white dark:bg-gray-900 rounded-lg shadow-xl overflow-hidden"
        ...
        >
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="text-sm text-gray-600 dark:text-gray-400">
              <div className="mb-1">
                <span className="font-medium">From:</span> carlos@basaltex.com.mx
              </div>
              <div className="mb-1">
                <span className="font-medium">To:</span> client@company.com
              </div>
              <div>
                <span className="font-medium">Subject:</span> Propuesta de proyecto - Basaltex
              </div>
            </div>
          </div>
          ...
          <div className="p-6 text-gray-800 dark:text-gray-200 leading-relaxed">
            ...
            <p className="mb-4">
              Me da mucho gusto saludarle y poder presentar nuestra propuesta para el proyecto que nos ha compartido. En
              Basaltex nos especializamos en proyectos de construcción sustentable y desarrollo urbano, con más de 15
            ...
            <p className="mb-4">
              Para mostrarle todos sus ventajas, le invitamos a nuestro webinar el próximo "martes 15 de junio a las
              10:00h", donde repasaremos:
            </p>
                    ...
                    <tr>
                      ...
                      <td style={{ verticalAlign: "top", paddingTop: "20px", paddingLeft: "20px" }}>
                        <div style={{ fontWeight: "bold", margin: "0", padding: "0 0 1px 0", fontSize: "16px" }}>
                          {signatureData.fullName || "Carlos del Castillo"}
                        </div>
                        <div
                          style={{
                            margin: "0",
                        ...
                        >
                          {signatureData.title || "Director General - Founder"}
                        </div>
                        <div
                          style={{
                            margin: "0",
                        ...
                        >
                          tel.: {signatureData.phone || "+55 18 20 21 63"}
                        </div>
                        <div
                          style={{
                            margin: "0",
                        ...
                        >
                          mail:{" "}
                          <a
                            href={`mailto:${signatureData.email || "cdelcastillo@basaltex.com.mx"}`}
                            style={{ color: "currentColor", textDecoration: "none", opacity: 0.6 }}
                          >
                        ...
                        <div style={{ margin: "0", padding: "0 0 1px 0", fontSize: "15px", fontWeight: "bold" }}>
                          <a
                            href={`https://${signatureData.website || "basaltex.mx"}`}
                            style={{ color: "currentColor", textDecoration: "none" }}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            {signatureData.website || "basaltex.mx"}
                          </a>
                        </div>
                        <div style={{ margin: "0", padding: "0 0 40px 0", fontSize: "15px" }}>
                          <a
                            href={`https://instagram.com/${signatureData.instagram || "basaltex.mx"}`}
                            style={{ color: "currentColor", textDecoration: "none" }}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                        ...
                        >
                          // {signatureData.tagline || "Ideas en Concreto"}
                        </div>
                      </td>
                    </tr>
                  </tbody>
